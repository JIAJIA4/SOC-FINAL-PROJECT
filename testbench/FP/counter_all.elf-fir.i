...
void __attribute__ ( ( section ( ".mprjram" ) ) ) initfir() {
 ...
 (*(volatile uint32_t*)0x30001040) = 0;
 (*(volatile uint32_t*)0x30001044) = -10;
 (*(volatile uint32_t*)0x30001048) = -9;
 (*(volatile uint32_t*)0x3000104c) = 23;
 (*(volatile uint32_t*)0x30001050) = 56;
 (*(volatile uint32_t*)0x30001054) = 63;
 (*(volatile uint32_t*)0x30001058) = 56;
 (*(volatile uint32_t*)0x3000105c) = 23;
 (*(volatile uint32_t*)0x30001060) = -9;
 (*(volatile uint32_t*)0x30001064) = -10;
 (*(volatile uint32_t*)0x30001068) = 0;

 (*(volatile uint32_t*)0x30001010) = 64;
}

int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){

 int ans;
 (*(volatile uint32_t*)0x30001000) = 1;

 initfir();

 for(int i = 0; i < 64; i++){
  while(!(((*(volatile uint32_t*)0x30001000) >> 4) & 1))
   ;

  (*(volatile uint32_t*)0x30001080) = i;

  while(!(((*(volatile uint32_t*)0x30001000) >> 5) & 1))
   ;

  outputsignal[i] = (*(volatile uint32_t*)0x30001084);
 }
