...
.Ltext0:
	...
	.file 0 "/home/ubuntu/Desktop/Final_Project/testbench/FP" "fir.c"
	.globl	outputsignal
	.bss
	.align	2
...
.L8:
	...
	nop
.L9:
	.loc 2 38 13 discriminator 1
	li	a5,805310464
	lw	a5,0(a5)
	.loc 2 38 9 discriminator 1
	andi	a5,a5,32
	beq	a5,zero,.L9
	.loc 2 41 22 discriminator 2
	li	a5,805310464
	addi	a5,a5,132
	lw	a5,0(a5)
	mv	a3,a5
	.loc 2 41 19 discriminator 2
	lui	a5,%hi(outputsignal)
	addi	a4,a5,%lo(outputsignal)
	lw	a5,-20(s0)
	slli	a5,a5,2
