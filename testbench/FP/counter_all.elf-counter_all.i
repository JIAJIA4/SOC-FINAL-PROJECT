...
# 150 "counter_all.c"
  (*(volatile uint32_t*)0x2600000c) = 0xAAAAAAAA;
 ...
 (*(volatile uint32_t*)0x2600000c) = 0xBBBBBBBB;


 int* tmp2 = qsort();
 (*(volatile uint32_t*)0x2600000c) = *tmp2 << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp2+9) << 16;
 ...
 for(int i = 0; i < 64; i++)
  (*(volatile uint32_t*)0x2600000c) = *(tmp3 + i) << 16;
# 195 "counter_all.c"
